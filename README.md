...
- manager: `http://localhost:3000/dashboard` cu `manager / manager123!`
...
6. Intră în `/dashboard` cu `manager / manager123!`.
...
1. Intră în `/dashboard` cu `manager / manager123!`.
...
7. Intră în `/dashboard` cu `manager / manager123!`.
