...
export default function ErrorPage({
  ...
  return (
    <main className="min-h-screen w-full bg-[#f6efe6] px-4 py-8 text-[#24170f]">
      <div className="mx-auto flex min-h-[70vh] max-w-2xl items-center justify-center">
        <section className="w-full rounded-[2rem] border border-[#eadfce] bg-[#fffdf8] p-6 text-center shadow-[0_18px_60px_rgba(36,23,15,0.08)] sm:p-8">
          ...
          <h1 className="mt-3 text-3xl font-semibold">Cette page n’a pas pu charger.</h1>
          <p className="mt-4 text-sm leading-7 text-[#6f5b4a]">
            Une erreur est survenue pendant le rendu. Recharge la page ou retourne à l’accueil.
          </p>
